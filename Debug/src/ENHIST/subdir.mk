...
src/ENHIST/%.o: ../src/ENHIST/%.cu
	...
	/usr/local/cuda-8.0/bin/nvcc -I/usr/include/opencv -I/usr/include/GL -I../include -I../src/capture -I../src/OSA_CAP/inc -I../src/encTrans -I../src -G -g -O0 -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_50,code=sm_50 -m64 -odir "src/ENHIST" -M -o "$(@:%.o=%.d)" "$<"
